...
# or
load("C:/Users/Mike/Desktop/Dropbox/absences/workspace - all glms dredge - scaled_out - reduced4 - coeff_plots.RData")
...
avg_LM_scaled_out_reduc_coeff$predictors[avg_LM_scaled_out_reduc_coeff$predictors == "depth_max_m"] <- "depth"
...
avg_SP_scaled_out_reduc_coeff$predictors[avg_SP_scaled_out_reduc_coeff$predictors == "depth_max_m"] <- "depth"
...
avg_W_scaled_out_reduc_coeff$predictors[avg_W_scaled_out_reduc_coeff$predictors == "depth_max_m"] <- "depth"
...
avg_FPpres_scaled_out_reduc_coeff$predictors[avg_FPpres_scaled_out_reduc_coeff$predictors == "depth_max_m"] <- "depth"
...
avg_FPrich_scaled_out_reduc_coeff$predictors[avg_FPrich_scaled_out_reduc_coeff$predictors == "depth_max_m"] <- "depth"
