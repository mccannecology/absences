...
ggsave("map_all_species_glm_scaled_out_reduc4.jpg",map_all_species_glm,height=12,width=24)
...
ggsave("map_LM_glm_model_avg_scaled_out_reduc4.jpg",map_LM_glm,height=8,width=11)
...
ggsave("map_SP_glm_model_avg_scaled_out_reduc4.jpg",map_SP_glm,height=8,width=11)
...
ggsave("map_W_glm_model_avg_scaled_out_reduc4.jpg",map_W_glm,height=8,width=11)
...
ggsave("map_FPpres_glm_model_avg_scaled_out_reduc4.jpg",map_FPpres_glm,height=8,width=11)
...
ggsave("map_FPrich_glm_model_avg_scaled_out_reduc4.jpg",map_FPrich_glm,height=8,width=11)
