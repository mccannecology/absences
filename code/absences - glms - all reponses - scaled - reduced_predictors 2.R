...
write.csv(all_glm_LM_scaled_reduc[1:numb_models],file="all_glm_LM_scaled_reduc2.csv",na="NA")
save(list = ls(all = TRUE), file = "workspace - all glms dredge - scaled - reduced2.RData")
...
write.csv(all_glm_SP_scaled_reduc[1:numb_models],file="all_glm_SP_scaled_reduc2.csv",na="NA")
save(list = ls(all = TRUE), file = "workspace - all glms dredge - scaled - reduced2.RData")
...
write.csv(all_glm_W_scaled_reduc[1:numb_models],file="all_glm_W_scaled_reduc2.csv",na="NA")
save(list = ls(all = TRUE), file = "workspace - all glms dredge - scaled - reduced2.RData")
...
write.csv(all_glm_FPpres_scaled_reduc[1:numb_models],file="all_glm_FPpres_scaled_reduc2.csv",na="NA")
save(list = ls(all = TRUE), file = "workspace - all glms dredge - scaled - reduced2.RData")
...
write.csv(all_glm_FPrich_scaled_reduc[1:numb_models],file="all_glm_FPrich_scaled_reduc2.csv",na="NA")
save(list = ls(all = TRUE), file = "workspace - all glms dredge - scaled - reduced2.RData")
