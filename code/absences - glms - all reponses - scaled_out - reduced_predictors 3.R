...
write.csv(all_glm_LM_scaled_out_reduc[1:numb_models],file="all_glm_LM_scaled_out_reduc3.csv",na="NA")
save(list = ls(all = TRUE), file = "workspace - all glms dredge - scaled_out - reduced3.RData")
...
write.csv(all_glm_SP_scaled_out_reduc[1:numb_models],file="all_glm_SP_scaled_out_reduc3.csv",na="NA")
save(list = ls(all = TRUE), file = "workspace - all glms dredge - scaled_out - reduced3.RData")
...
write.csv(all_glm_W_scaled_out_reduc[1:numb_models],file="all_glm_W_scaled_out_reduc3.csv",na="NA")
save(list = ls(all = TRUE), file = "workspace - all glms dredge - scaled_out - reduced3.RData")
...
write.csv(all_glm_FPpres_scaled_out_reduc[1:numb_models],file="all_glm_FPpres_scaled_out_reduc3.csv",na="NA")
save(list = ls(all = TRUE), file = "workspace - all glms dredge - scaled_out - reduced3.RData")
...
write.csv(all_glm_FPrich_scaled_out_reduc[1:numb_models],file="all_glm_FPrich_scaled_out_reduc3.csv",na="NA")
save(list = ls(all = TRUE), file = "workspace - all glms dredge - scaled_out - reduced3.RData")
