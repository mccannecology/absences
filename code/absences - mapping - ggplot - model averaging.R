...
map_LM_glm2 <- map_LM_glm2 + scale_colour_gradient2(limits=c(0,1),name="Predicted",low="blue", mid="white", high="red",midpoint=0.5)
map_LM_glm2 <- map_LM_glm2 + scale_fill_gradient2(limits=c(0,1),name="Predicted",low="blue", mid="white", high="red",midpoint=0.5)
...
map_SP_glm2 <- map_SP_glm2 + scale_colour_gradient2(limits=c(0,1),name="Predicted",low="blue", mid="white", high="red",midpoint=0.5)
map_SP_glm2 <- map_SP_glm2 + scale_fill_gradient2(limits=c(0,1),name="Predicted",low="blue", mid="white", high="red",midpoint=0.5)
...
map_W_glm2 <- map_W_glm2 + scale_colour_gradient2(limits=c(0,1),name="Predicted",low="blue", mid="white", high="red",midpoint=0.5)
...
map_FPpres_glm2 <- map_FPpres_glm2 + scale_colour_gradient2(limits=c(0,1),name="Predicted",low="blue", mid="white", high="red",midpoint=0.5)
...
map_FPpres_glm <- map_FPpres_glm + scale_colour_gradient2(limits=c(0,1),name="Predicted",low="blue", mid="white", high="red",midpoint=0.5)
...
map_FPrich_glm <- map_FPrich_glm + scale_colour_gradient2(limits=c(0,4),name="Predicted",low="blue", mid="white", high="red",midpoint=2)
map_FPrich_glm <- map_FPrich_glm + geom_point(data=data_glm_map, aes(x=lon, y=lat, colour=FPrich_pred, shape=as.factor(FPrich_obsv)), size=4) 
...
map_FPrich_glm <- map_FPrich_glm + scale_colour_gradient2(limits=c(0,4),name="Richness",low="blue", mid="white", high="red",midpoint=2)
map_FPrich_glm <- map_FPrich_glm + theme_classic(base_size=18)
map_FPrich_glm <- map_FPrich_glm + scaleBar(lon = -72.5, lat = 41.,          # add a scale bar
                                            distanceLon = 25, 
                                            distanceLat = 4, distanceLegend = 6, 
...
map_FPrich_glm <- map_FPrich_glm + scale_fill_gradientn("Richness",colours=c("blue","white","red"))
map_FPrich_glm <- map_FPrich_glm + theme_classic(base_size=18)
map_FPrich_glm <- map_FPrich_glm + scaleBar(lon = -72.5, lat = 41.,          # add a scale bar
                                            distanceLon = 25, 
                                            distanceLat = 4, distanceLegend = 9, 
